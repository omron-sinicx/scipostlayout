...
class T5SciPostLayoutMultiTaskSamplingDataset(T5MultiTaskSamplingDataset, SciPostLayoutDataset):
    def __init__(self, args, tokenizer, task_config, split, online_process=True,
                 remove_too_long_layout: bool = False, sort_by_pos: bool = True) -> None:
        super().__init__(args, tokenizer, task_config=task_config,
                         sort_by_pos=sort_by_pos,
...
class T5SciPostLayoutMultiTaskConcatDataset(T5MultiTaskConcatDataset, SciPostLayoutDataset):
    def __init__(self, args, tokenizer, task_config, split, online_process=True,
                 remove_too_long_layout: bool = False, sort_by_pos: bool = True) -> None:
        super().__init__(args, tokenizer, task_config=task_config,
                         sort_by_pos=sort_by_pos,
...
class T5SciPostLayoutMultiTaskRotationDataset(T5MultiTaskRotationDataset, SciPostLayoutDataset):
    def __init__(self, args, tokenizer, task_config, split, online_process=True,
                 remove_too_long_layout: bool = False, sort_by_pos: bool = True) -> None:
        super().__init__(args, tokenizer, task_config=task_config,
                         sort_by_pos=sort_by_pos,
...
class T5SciPostLayoutMultiTaskPartitionDataset(T5MultiTaskPartitionDataset, SciPostLayoutDataset):
    def __init__(self, args, tokenizer, task_config, split, online_process=True,
                 remove_too_long_layout: bool = False, sort_by_pos: bool = True,
                 task_buckets: str = None) -> None:
        super().__init__(args, tokenizer, task_config=task_config,
...
class T5SciPostLayoutMultiTaskFineGrainedPartitionDataset(T5MultiTaskFineGrainedPartitionDataset, SciPostLayoutDataset):
    def __init__(self, args, tokenizer, task_config, split, online_process=True,
                 remove_too_long_layout: bool = False, sort_by_pos: bool = True,
                 task_data_size: str = None, task_weights: str = None) -> None:
        super().__init__(args, tokenizer, task_config=task_config, sort_by_pos=sort_by_pos,
