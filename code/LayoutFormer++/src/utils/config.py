...
def add_arguments(parser):
    ...
    parser.add_argument('--gen_const_path', type=str, default='',
                        help='extracted constraint path')

    # data
    parser.add_argument('--dataset', type=str, choices=['rico', 'publaynet', 'scipostlayout'],
                        help='dataset name')
