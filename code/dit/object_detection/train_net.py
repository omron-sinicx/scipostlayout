...
def main(args):
    ...
    register_coco_instances(
        "scipostlayout_train",
        {},
        "/scipostlayout/scipostlayout/poster/png/train.json",
        "/scipostlayout/scipostlayout/poster/png/train"
    )
    register_coco_instances(
        "scipostlayout_dev",
        {},
        "/scipostlayout/scipostlayout/poster/png/dev.json",
        "/scipostlayout/scipostlayout/poster/png/dev"
    )
    register_coco_instances(
        "scipostlayout_test",
        {},
        "/scipostlayout/scipostlayout/poster/png/test.json",
        "/scipostlayout/scipostlayout/poster/png/test"
    )
